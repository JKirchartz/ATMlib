...
* Transpose (also for microtonals): play [notes](https://en.wikipedia.org/wiki/Musical_note "note wikipedia") in a different key transposition or fine tune notes to provide microtonals; frequencies that are in between note.
