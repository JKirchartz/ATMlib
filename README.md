...
**…**						| **…**													| **…**								| **…**
**64+92<br/>156<br/>0x9D**	| ADD song tempo (*__X__*)								| UBYTE (8-bit)						| adds *[__X__]* to the tempo of the song.<br/>Total value should be between 0 - 127<br/>**_Note:_** the higher the tempo to more CPU it takes.
