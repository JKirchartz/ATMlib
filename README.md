...
| **64+4<br/>68<br/>0x44**      | slide Frequency ON (*__X__*) | UBYTE (8-bit) | Slide the frequency with an amount (positive or negative) of *[__X__]* for every tick.<br/> **_Note:_**<br/> The amount of slide is limited between -127 to 127|
