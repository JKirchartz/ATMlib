...
Song testmusic[] = {   // A) Sample music =>
  ...
  0x9F + 1,      // DELAY: ticks = 1
  0x40, 17,      // FX: SET VOLUME: volume = 32
  0x9F + 1,      // DELAY: ticks = 1
  0x40,  0,      // FX: SET VOLUME: volume = 0
  0x9F + 14,      // DELAY: ticks = 14

  0x40, 63,      // FX: SET VOLUME: volume = 48
  0x9F + 2,      // DELAY: ticks = 2
  0x40, 47,      // FX: SET VOLUME: volume = 38
  0x9F + 2,      // DELAY: ticks = 2
  0x40, 31,      // FX: SET VOLUME: volume = 28
  0x9F + 2,      // DELAY: ticks = 2
  0x40, 15,      // FX: SET VOLUME: volume = 18
  0x9F + 2,      // DELAY: ticks = 2
  0x40,  0,      // FX: SET VOLUME: volume = 0
