...
Song testmusic[] = {   // A) Sample music =>
  ...
  //"Track 5",
  0xFD, 31, 6,   // REPEAT: track = 5, count = 32
  0xFE,          // RETURN
  ...
  //"Track 7",
  0xFD, 31, 8,    // REPEAT: track = 5, count = 32
  0xFE,          // RETURN

  //"Track 8",
  0x40, 48,      // FX: SET VOLUME: volume = 48
  0x00 +  8,     // NOTE ON: note = 20
  0x9F +  2,     // DELAY: ticks = 3
  0x3F,          // NOTE OFF
  0x9F +  30,    // DELAY: ticks = 1
  0xFE,          // RETURN
};
